package ru.socialeducationapps.worldmetrics.opengl.shadertoy.draws

import android.opengl.GLES20
import ru.socialeducationapps.worldmetrics.global.AssetsContainer.Companion.openRawResource
import ru.socialeducationapps.worldmetrics.opengl.GLESHelper.Companion.BYTES_PER_VERTEX
import ru.socialeducationapps.worldmetrics.opengl.GLESHelper.Companion.COORDS_PER_VERTEX_2D
import ru.socialeducationapps.worldmetrics.opengl.GLESHelper.Companion.VARIABLE_POSITION
import ru.socialeducationapps.worldmetrics.opengl.GLESHelper.Companion.coordsToByteBuffer
import ru.socialeducationapps.worldmetrics.opengl.PlaybackTimer
import ru.socialeducationapps.worldmetrics.opengl.shadertoy.ShaderToyHelper.Companion.VARIABLE_FRAME
import ru.socialeducationapps.worldmetrics.opengl.shadertoy.ShaderToyHelper.Companion.VARIABLE_RESOLUTION
import ru.socialeducationapps.worldmetrics.opengl.shadertoy.ShaderToyHelper.Companion.VARIABLE_TIME
import ru.socialeducationapps.worldmetrics.opengl.shadertoy.ShaderToyHelper.Companion.createOpenGLESProgram
